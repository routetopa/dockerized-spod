  ...
  var Table = module.exports = View.extend({
    ...
    initialize: function (o) {
      ...
      window.addEventListener('message', function (e) {
        if (e.data != "ethersheet_sheet_updated") {
    ...
    setSheet: function (sheet) {
      this.models.set('sheet', sheet, {
        ...
        //'insert_col': 'render',
        //'delete_col': 'render',
        'insert_col': 'paginationRender',
        'delete_col': 'paginationRender',
        //'insert_row': 'render',
        'insert_row': 'paginationRender',
        //'delete_row': 'render',
        'delete_row': 'paginationRender',
        //'sort_rows':  'render',
        'sort_rows': 'paginationRender',
    ...
    drawRowHeaders: function (row_headers_offset) {
      var view = this;
      var html = '';
      var row_name = '';
      var height = null;
