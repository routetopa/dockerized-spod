...
$queryList = array(
    ...
    "ALTER TABLE  `" . OW_DB_PREFIX . "base_search_result` ENGINE = InnoDB",
	"ALTER TABLE  `" . OW_DB_PREFIX . "base_preference_section` ENGINE = InnoDB",
	"ALTER TABLE  `" . OW_DB_PREFIX . "base_preference_data` ENGINE = InnoDB",
	"ALTER TABLE  `" . OW_DB_PREFIX . "base_log` ENGINE = InnoDB",
	"ALTER TABLE  `" . OW_DB_PREFIX . "base_search` ENGINE = InnoDB",
